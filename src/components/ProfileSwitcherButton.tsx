...
const ProfileSwitcherButton: React.FC = () => {
  ...
  return (
    <TouchableOpacity
      ...
      style={[styles.chip, { backgroundColor: 'rgba(255,255,255,0.18)', maxWidth: Math.min(Math.round(160 * fontScale), width * 0.44) }]}
...
const getStyles = (scale: number = 1) => {
  ...
  return StyleSheet.create({
    ...
    text: { fontSize: s(14), fontWeight: '600', flexShrink: 1 },
  });
};
